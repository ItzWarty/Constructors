...
namespace Tests {
   public class AllFieldsTests : WeaverTestsBase {
      public AllFieldsTests() : base(typeof(AllFieldsExampleClass)) { }

      [Fact]
      public void AllFieldsConstructor_Interface() {
      ...
      [Fact]
      public void AllFieldsConstructor_Properties() {
         var addedCtor = type.GetConstructors().First(c => c.GetParameters().Length > 0);
