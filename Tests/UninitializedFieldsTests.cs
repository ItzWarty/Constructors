...
namespace Tests {
   public class UninitializedFieldsTests : WeaverTestsBase {
      ...
      public void UninitializedFieldsConstructor_Interface() {
         ...
         Assert.Equal("f3", parameters[1].Name);
      ...
      public void UninitializedFieldsConstructor_Properties() {
         ...
         Assert.Equal("derp", instance.GetType().GetProperty("F1").GetValue(instance, null));
         Assert.Equal("test", instance.GetType().GetProperty("F2").GetValue(instance, null));
         Assert.Equal("asdf", instance.GetType().GetProperty("F3").GetValue(instance, null));
      }
   }
}